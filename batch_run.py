...
for i in range(0, files_num):
    ...
    a.generate_aberration(input, output, samples, exposure, aberration, aberration_size, chromatic_aberration, dark_current_noise, readout_noise, shot_noise, x_max, x_min, y_min, y_max)
